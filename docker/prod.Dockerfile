...
# Meta data
LABEL maintainer="nick.anthony.flueckiger@hey.com"
LABEL description="A local yaml editor for both local and remote sources"
...
WORKDIR /
COPY --from=builder /usr/src/app/target/release/yedit .
